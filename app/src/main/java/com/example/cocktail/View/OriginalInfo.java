...
public class OriginalInfo {
    ...
    public OriginalInfo(String Name, String 설명, String ImageURL, String Taste, String Alcoholicity,
                        ...
                        String Ingredients7, String Main_Alcohol, String TPO, String Tag){
        this.Name = Name;
        this.설명 = 설명;
